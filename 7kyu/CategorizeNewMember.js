...
function openOrSenior(data){
    //iterate the array 
    let seniorityList = data.map(e => {
      //check that first index of each iterated element is greater than 55
      //check if the second index is greater than 7 
      if(e[0] >= 55 && e[1] > 7) {
        //if both are true reassign to "open" else reassign as "senior"
        return e = "Senior"
      } else {
        return e = "Open"
      }
